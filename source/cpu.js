...
JSNES_CPU.prototype.reset = function () {
  // Main memory
...
JSNES_CPU.prototype.load = function (addr) {
  if (addr < 0x2000) {
...
JSNES_CPU.prototype.load16bit = function (addr) {
  if (addr < 0x1FFF) {
...
JSNES_CPU.prototype.toJSON = function () {
  return JSNES_Utils.toJSON(this)
}

JSNES_CPU.prototype.fromJSON = function (s) {
