...
JSNES_PPU.prototype = {
  ...
  reset: function () {
    ...
    for (i = 0; i < 512; i++) {
      this.ptTile[i] = new JSNES_PPU.Tile()
    }
    ...
    for (i = 0; i < 4; i++) {
      this.nameTable[i] = new JSNES_PPU.NameTable(32, 32, 'Nt' + i)
    }
    ...
    this.palTable = new JSNES_PPU.PaletteTable()
...
JSNES_PPU.NameTable = function (width, height, name) {
  this.width = width
  this.height = height
  this.name = name
...
JSNES_PPU.PaletteTable = function () {
  this.curTable = new Array(64)
  this.emphTable = new Array(8)
  this.currentEmph = -1
}

JSNES_PPU.PaletteTable.prototype = {
  reset: function () {
    this.setEmphasis(0)
  },
