...
function JSNES_PPU (nes) {
  if (!(this instanceof JSNES_PPU)) return new JSNES_PPU(nes)
  this.nes = nes
...
JSNES_PPU.prototype.reset = function () {
  var i
  ...
  for (i = 0; i < 4; i++) {
    this.nameTable[i] = new JSNES_PPU_NameTable(32, 32, 'Nt' + i)
  }
...
JSNES_PPU.prototype.setMirroring = function (mirroring) {
...
JSNES_PPU.prototype.defineMirrorRegion = function (fromStart, toStart, size) {
  for (var i = 0;i < size;i++) {
    this.vramMirrorTable[fromStart + i] = toStart + i
  }
}

JSNES_PPU.prototype.startVBlank = function () {
...
JSNES_PPU.prototype.startFrame = function () {
...
JSNES_PPU.prototype.updateControlReg1 = function (value) {
  this.triggerRendering()
...
JSNES_PPU.prototype.setStatusFlag = function (flag, value) {
  var n = 1 << flag
...
JSNES_PPU.prototype.readStatusRegister = function () {
...
JSNES_PPU.prototype.sramLoad = function () {
...
// The address should be set first.
JSNES_PPU.prototype.sramWrite = function (value) {
...
// horizontal offset:
JSNES_PPU.prototype.scrollWrite = function (value) {
  this.triggerRendering()
...
JSNES_PPU.prototype.writeVRAMAddress = function (address) {
  if (this.firstWrite) {
...
JSNES_PPU.prototype.vramLoad = function () {
  var tmp
...
JSNES_PPU.prototype.vramWrite = function (value) {
  this.triggerRendering()
  this.cntsToAddress()
  this.regsToAddress()
...
// into Sprite RAM.
JSNES_PPU.prototype.sramDMA = function (value) {
...
JSNES_PPU.prototype.regsToAddress = function () {
...
JSNES_PPU.prototype.cntsToAddress = function () {
...
JSNES_PPU.prototype.incTileCounter = function (count) {
...
JSNES_PPU.prototype.mirroredLoad = function (address) {
  return this.vramMem[this.vramMirrorTable[address]]
}

// Writes to memory, taking into account
// mirroring/mapping of address ranges.
JSNES_PPU.prototype.mirroredWrite = function (address, value) {
...
JSNES_PPU.prototype.triggerRendering = function () {
  if (this.scanline >= 21 && this.scanline <= 260) {
...
JSNES_PPU.prototype.renderFramePartially = function (startScan, scanCount) {
...
JSNES_PPU.prototype.renderBgScanline = function (bgbuffer, scan) {
...
JSNES_PPU.prototype.renderSpritesPartially = function (startscan, scancount, bgPri) {
  if (this.f_spVisibility === 1) {
    for (var i = 0;i < 64;i++) {
...
JSNES_PPU.prototype.checkSprite0 = function (scan) {
  this.spr0HitX = -1
  this.spr0HitY = -1
...
// appropriately.
JSNES_PPU.prototype.writeMem = function (address, value) {
...
JSNES_PPU.prototype.updatePalettes = function () {
  var i
...
JSNES_PPU.prototype.patternWrite = function (address, value) {
...
// with this new byte.
JSNES_PPU.prototype.nameTableWrite = function (index, address, value) {
...
// table byte.
JSNES_PPU.prototype.attribTableWrite = function (index, address, value) {
  this.nameTable[index].writeAttrib(address, value)
}

// Updates the internally buffered sprite
// data with this new byte of info.
JSNES_PPU.prototype.spriteRamWriteUpdate = function (address, value) {
...
JSNES_PPU.prototype.doNMI = function () {
  // Set VBlank flag:
  this.setStatusFlag(this.STATUS_VBLANK, true)
...
JSNES_PPU.prototype.JSON_PROPERTIES = [
  // Memory
  'vramMem', 'spriteMem',
  // Counters
...
JSNES_PPU.prototype.toJSON = function () {
  var i
  var state = JSNES_Utils.toJSON(this)
...
JSNES_PPU.prototype.fromJSON = function (state) {
  var i

  JSNES_Utils.fromJSON(this, state)
...
function JSNES_PPU_NameTable (width, height, name) {
  if (!(this instanceof JSNES_PPU_NameTable)) return new JSNES_PPU_NameTable()
  this.width = width
  this.height = height
  this.name = name
...
JSNES_PPU_NameTable.prototype.getTileIndex = function (x, y) {
  return this.tile[y * this.width + x]
}

JSNES_PPU_NameTable.prototype.getAttrib = function (x, y) {
  return this.attrib[y * this.width + x]
}

JSNES_PPU_NameTable.prototype.writeAttrib = function (index, value) {
  var basex = (index % 8) * 4
...
JSNES_PPU_NameTable.prototype.toJSON = function () {
  return {
    'tile': this.tile,
    'attrib': this.attrib
  }
...
JSNES_PPU_NameTable.prototype.fromJSON = function (s) {
  this.tile = s.tile
  this.attrib = s.attrib
}

function JSNES_PPU_PaletteTable () {
  if (!(this instanceof JSNES_PPU_PaletteTable)) return new JSNES_PPU_PaletteTable()
  this.curTable = new Array(64)
  this.emphTable = new Array(8)
  this.currentEmph = -1
}

JSNES_PPU_PaletteTable.prototype.reset = function () {
  this.setEmphasis(0)
}

JSNES_PPU_PaletteTable.prototype.loadNTSCPalette = function () {
...
JSNES_PPU_PaletteTable.prototype.loadPALPalette = function () {
  this.curTable = [0x525252, 0xB40000, 0xA00000, 0xB1003D, 0x740069, 0x00005B, 0x00005F, 0x001840, 0x002F10, 0x084A08, 0x006700, 0x124200, 0x6D2800, 0x000000, 0x000000, 0x000000, 0xC4D5E7, 0xFF4000, 0xDC0E22, 0xFF476B, 0xD7009F, 0x680AD7, 0x0019BC, 0x0054B1, 0x006A5B, 0x008C03, 0x00AB00, 0x2C8800, 0xA47200, 0x000000, 0x000000, 0x000000, 0xF8F8F8, 0xFFAB3C, 0xFF7981, 0xFF5BC5, 0xFF48F2, 0xDF49FF, 0x476DFF, 0x00B4F7, 0x00E0FF, 0x00E375, 0x03F42B, 0x78B82E, 0xE5E218, 0x787878, 0x000000, 0x000000, 0xFFFFFF, 0xFFF2BE, 0xF8B8B8, 0xF8B8D8, 0xFFB6FF, 0xFFC3FF, 0xC7D1FF, 0x9ADAFF, 0x88EDF8, 0x83FFDD, 0xB8F8B8, 0xF5F8AC, 0xFFFFB0, 0xF8D8F8, 0x000000, 0x000000]
  this.makeTables()
  this.setEmphasis(0)
}

JSNES_PPU_PaletteTable.prototype.makeTables = function () {
...
JSNES_PPU_PaletteTable.prototype.setEmphasis = function (emph) {
...
JSNES_PPU_PaletteTable.prototype.getEntry = function (yiq) {
  return this.curTable[yiq]
}

JSNES_PPU_PaletteTable.prototype.getRed = function (rgb) {
  return (rgb >> 16) & 0xFF
}

JSNES_PPU_PaletteTable.prototype.getGreen = function (rgb) {
  return (rgb >> 8) & 0xFF
}

JSNES_PPU_PaletteTable.prototype.getBlue = function (rgb) {
  return rgb & 0xFF
}

JSNES_PPU_PaletteTable.prototype.getRgb = function (r, g, b) {
  return ((r << 16) | (g << 8) | (b))
}

JSNES_PPU_PaletteTable.prototype.loadDefaultPalette = function () {
...
function JSNES_PPU_Tile () {
  if (!(this instanceof JSNES_PPU_Tile)) return new JSNES_PPU_Tile()
  // Tile data:
...
JSNES_PPU_Tile.prototype.setBuffer = function (scanline) {
  for (this.y = 0;this.y < 8;this.y++) {
    this.setScanline(this.y, scanline[this.y], scanline[this.y + 8])
  }
}

JSNES_PPU_Tile.prototype.setScanline = function (sline, b1, b2) {
...
JSNES_PPU_Tile.prototype.render = function (buffer, srcx1, srcy1, srcx2, srcy2, dx, dy, palAdd, palette, flipHorizontal, flipVertical, pri, priTable) {
...
JSNES_PPU_Tile.prototype.isTransparent = function (x, y) {
  return (this.pix[(y << 3) + x] === 0)
}

JSNES_PPU_Tile.prototype.toJSON = function () {
  return {
    'opaque': this.opaque,
    'pix': this.pix
  }
...
JSNES_PPU_Tile.prototype.fromJSON = function (s) {
